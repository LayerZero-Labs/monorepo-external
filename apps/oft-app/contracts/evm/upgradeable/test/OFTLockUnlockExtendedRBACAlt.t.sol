...
import { OFTLockUnlockExtendedRBACAltUpgradeable } from "./../contracts/extended/alt/OFTLockUnlockExtendedRBACAltUpgradeable.sol";
...
import { OFTLockUnlockExtendedRBACTest, OFTLockUnlockExtendedRBACHarness } from "./OFTLockUnlockExtendedRBAC.t.sol";

contract OFTLockUnlockExtendedRBACAltHarness is OFTLockUnlockExtendedRBACAltUpgradeable {
    constructor(address _token, address _endpoint) OFTLockUnlockExtendedRBACAltUpgradeable(_token, _endpoint, 0) {}
...
contract OFTLockUnlockExtendedRBACAltTest is OFTLockUnlockExtendedRBACTest {
    OFTLockUnlockExtendedRBACAltHarness altAdapter;
    ...
    function setUp() public virtual override {
        ...
        altAdapter = OFTLockUnlockExtendedRBACAltHarness(_deployTransparentProxy(impl, address(this), initData));
        adapter = OFTLockUnlockExtendedRBACHarness(address(altAdapter));
    ...
    function _deployHarness() internal virtual override returns (address) {
        return address(new OFTLockUnlockExtendedRBACAltHarness(address(token), endpoint));
    }
