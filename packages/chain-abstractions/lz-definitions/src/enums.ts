...
export enum ChainKey {
    ...
    UNICHAIN_SANDBOX = 'unichain-sandbox',
    //hyperliquid
    HYPERLIQUID = 'hyperliquid',
    HYPERLIQUID_TESTNET = 'hyperliquid-testnet',
    HYPERLIQUID_SANDBOX = 'hyperliquid-sandbox',
    //minato
    ...
    WORLDCHAIN_SANDBOX = 'worldchain-sandbox',
    //superposition
    SUPERPOSITION = 'superposition',
    ...
    MONAD_SANDBOX = 'monad-sandbox',
    //monad2
    MONAD2_TESTNET = 'monad2-testnet',
    //xdc
    XDC = 'xdc',
    XDC_SANDBOX = 'xdc-sandbox',
    //concrete
    CONCRETE = 'concrete',
    //plumephoenix
    PLUMEPHOENIX = 'plumephoenix',
    PLUMEPHOENIX_TESTNET = 'plumephoenix-testnet',
    PLUMEPHOENIX_SANDBOX = 'plumephoenix-sandbox',
    //megaeth
    MEGAETH = 'megaeth',
    ...
    //ault
    AULT = 'ault',
    AULT_TESTNET = 'ault-testnet',
    //gensyn
    GENSYN = 'gensyn',
    GENSYN_TESTNET = 'gensyn-testnet',
    //sei2
    SEI2_TESTNET = 'sei2-testnet',
    //seismic
    SEISMIC_TESTNET = 'seismic-testnet',
    //neox
    NEOX = 'neox',
    NEOX_TESTNET = 'neox-testnet',
    //rayls
    RAYLS = 'rayls',
    RAYLS_TESTNET = 'rayls-testnet',
    // adi
    ADI = 'adi',
...
export const CHAIN_NAME_TO_CHAIN_TYPE = {
    ...
    hoodi: ChainType.EVM,
    ault: ChainType.EVM,
    gensyn: ChainType.EVM,
    sei2: ChainType.EVM,
    seismic: ChainType.EVM,
    neox: ChainType.EVM,
    rayls: ChainType.EVM,
    adi: ChainType.EVM,
    adiri: ChainType.EVM,
    moninet: ChainType.EVM,
    onemoney: ChainType.EVM,
    ritual: ChainType.EVM,
    anubis: ChainType.EVM,
