import type { IReplaceOptions } from '../contracts';
...
export function addContent(
    ...
    if (options.removeDoubleBlankLines) {
        allLines = allLines.filter((line, index, lines) =>
            filterDoubleBlankLines(line, index, lines),
        );
    }
