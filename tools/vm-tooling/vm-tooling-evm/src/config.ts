...
export const images = {
    ...
    ['evm:forge-1.3.6-hardhat-2.26.3-patch-5']: {
        name: 'evm',
        versions: {
            forge: '1.3.6',
            hardhat: '2.26.3',
    ...
    ['evm:forge-1.3.6-hardhat-2.26.3-patch-6']: {
        name: 'evm',
        versions: {
            forge: '1.3.6',
            hardhat: '2.26.3',
...
export const versionCombinations: [VersionCombination<ImageId>, ...VersionCombination<ImageId>[]] =
    [
        {
            images: {
                forge: 'evm:forge-1.3.6-hardhat-2.26.3-patch-6',
                hardhat: 'evm:forge-1.3.6-hardhat-2.26.3-patch-6',
            },
            stable: true,
        },
        {
